/*****************************************************************************
* Filename:          C:\Users\mt171850\Documents\Pour_etudiant_TP_video\IVK_EDK_Demo\IVK_Repository\MyProcessorIPLib/drivers/my_xsvi_mux_v1_00_a/src/my_xsvi_mux_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the my_xsvi_mux driver
...
XStatus MY_XSVI_MUX_SelfTest(void * baseaddr_p)
{
  ...
  MY_XSVI_MUX_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MY_XSVI_MUX_mReadSlaveReg0(baseaddr, 0);
