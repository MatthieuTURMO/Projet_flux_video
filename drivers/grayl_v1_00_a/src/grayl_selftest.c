/*****************************************************************************
* Filename:          C:\Users\mt171850\Documents\Pour_etudiant_TP_video\IVK_EDK_Demo\IVK_Repository\MyProcessorIPLib/drivers/grayl_v1_00_a/src/grayl_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the grayl driver
...
XStatus GRAYL_SelfTest(void * baseaddr_p)
{
  ...
  GRAYL_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = GRAYL_mReadSlaveReg0(baseaddr, 0);
