------------------------------------------------------------------------------
-- grayl.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
-- Date:              Mon Nov 28 15:11:12 2016 (by Create and Import Peripheral Wizard)
...
library grayl_v1_00_a;
use grayl_v1_00_a.user_logic;
...
entity grayl is
  ...
  (
	...
	clk : in std_logic;
	gray_sel  : in  std_logic_vector (1 downto 0):="11";
	-- XSVI_IN ports
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity grayl_v1_00_a.user_logic
    generic map
    (
